...
const SortableList: React.FC<Props> = ({ listName, items, nameField, setItemsList, handleEdit, addItem }) => {
  ...
  return (
    <Grid container>
      {addItem && (
        <Button variant='text' color='secondary' onClick={() => addItem(items)}>
          Agregar
        </Button>
      )}
      {loading ? (
                      ...
                      render={() => (
                        <>
                          <ListItem>
                            ...
                            <ListItemText primary={item[nameField]} />
                            <IconButton
                              size='small'
                              onClick={() => {
                                handleEdit(index)
